...
class Config:
    """AdaLog backend settings for the COCO detection experiments (W3/A3).

    Used for the 3/3 uniform baseline row and, with
    ``--candidate-bits 2 3 4 --target-avg-bit 3.0``, the MP3/MP3 row.
